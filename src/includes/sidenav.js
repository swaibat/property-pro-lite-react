      ...
      return (
        ...
        <ul className="navbar fixed-left" id="collapse-menu">
            <div id="avatar-space" className="flex-center">
                <img id="avatar" className="circle avatar-holder" src="./assets/img/user.svg" alt="user"/>
            ...
            <ul className="margin-x-3">
                {
                    navData.map(el =>(
                        <Link to='/dashboard'>
                            <li  onClick={this.handleClick} className="nav-item active" ><i className="pro-home-lite margin-r-2"></i>Dashboard</li>
                        </Link>
                    ))
                    }
            </ul> 
